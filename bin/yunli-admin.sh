...
ROOT_DIR="/var/www/yunli/admin/"
LOG_DIR="/var/www/log/yunli/admin"
APP_NAME=yunli-admin.jar

usage() {
    echo "用法: sh yunli-admin.sh [start(启动)|stop(停止)|restart(重启)|status(状态)|log(实时监控日志)]"
    exit 1
}
